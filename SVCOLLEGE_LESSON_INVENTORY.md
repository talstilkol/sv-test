...
| 6 | `lesson_devops_deploy` | Vercel/Docker/CI-CD/testing | deployment, env vars, Docker, Docker Compose, CI workflow, smoke tests | `React_Architect_Blueprint.pdf` כבסיס testing/architecture חלקי; נדרש מקור DevOps ייעודי |
| 7 | `lesson_nestjs_bridge` | Nest.js + DI | modules, controllers, providers, dependency injection, validation pipe, Express comparison | `lessons/Lesson 16.pptx.pdf`, `lessons/Lesson 17.pptx.pdf` כגשר Express; נדרש מקור Nest ייעודי |
