...
|---|---|---|---|
| Diagnostic intake covers exam domains, graph scoring, placement, first-week plan, latency, why-path, retake and export | pass | P7.1.1, P7.1.2, P7.1.3, P7.1.4, P7.1.5, P7.1.6, P7.1.7, P7.1.8 | Diagnostic rows are built from existing lesson concepts and question ids only. |
| Daily missions cover SRS, weak concepts, capstones, exam, time boxes, balance, recovery, forecast, agreement and EOD summary | pass | P7.2.1, P7.2.2, P7.2.3, P7.2.4, P7.2.5, P7.2.6, P7.2.7, P7.2.8 | Plans do not pad missions when evidence is missing. |
