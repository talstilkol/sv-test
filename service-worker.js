...
const CACHE_VERSION = "lumen-v2.4.161-exam100-ide-audit";
...
const SHELL_ASSETS = [
  ...
  "/src/views/exam100-path-core.js",
  ...
  "/src/views/lesson-renderer/lesson-renderer.js?v=lesson-renderer-v1",
  "/src/views/chrome-menu/chrome-menu.js?v=chrome-menu-v1",
  "/src/views/settings-preferences/settings-preferences.js?v=settings-preferences-v1",
  "/src/views/bug-agent/bug-agent-ui.js?v=bug-agent-ui-v1",
  "/src/views/question-panels/question-panels.js?v=question-panels-v1",
  ...
  // /data/* content files (auto-synced from index.html).
  ...
  "/data/cluster_index.js?v=cluster-v1",
  "/data/code_blocks.js",
  "/data/comparisons.js",
  ...
  "/data/exam_manual_review_promotions.js",
  "/data/exam_manual_review_promotions.js?v=exam-manual-review-promotions-v1",
  ...
  "/data/level100_release_gates.js",
  ...
  "/data/pair_match.js",
  "/data/pathways.js",
  "/data/portal_decision_aids.js",
  "/data/portal_decision_aids.js?v=portal-decision-aids-v1",
  ...
  "/data/scenarios.js",
  "/data/site_navigation_tree.js",
  "/data/site_navigation_tree.js?v=site-tree-v1",
  "/data/solution_guide_drills.js",
  "/data/solution_guide_drills.js?v=solution-guide-drills-v1",
  "/data/stage_zero.js",
  ...
  "/data/zz_questions_bug_phase2.js?v=phase2-v1",
