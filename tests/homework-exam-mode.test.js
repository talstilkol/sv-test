...
describe("Homework Exam Mode", () => {
  ...
  it("ships a local completion tracker for the master plan UI", () => {
    ...
    expect(viewSource).toContain("עץ תרגילי המבחן");
    expect(viewSource).toContain("data-exam-task-technical-task");
    expect(viewSource).toContain("manual_review נשאר חסום");
    ...
    expect(viewSource).toContain("renderExam100FullReadinessBoard");
    expect(viewSource).toContain("timePlanState");
    expect(viewSource).toContain("updateRemainingTimePlan");
    expect(viewSource).toContain("data-exam100-full-readiness");
    expect(viewSource).toContain("לוח משימות מלא ל-100 במבחן");
    expect(viewSource).toContain("פתח לוח מלא וסמן V");
    ...
    expect(cssSource).toContain(".hxm-exam100-full-readiness");
    expect(cssSource).toContain(".hxm-exam100-full-cards");
