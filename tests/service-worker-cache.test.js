...
describe("service worker cache freshness", () => {
  ...
  it("uses a fresh cache version for concept sprint assets", () => {
    expect(sw).toContain('const CACHE_VERSION = "lumen-v2.4.130"');
    expect(html).toContain("style.css?v=concept-sprint-v69");
    expect(html).toContain("app.js?v=concept-sprint-v69");
    ...
    expect(sw).toContain("/app.js?v=concept-sprint-v69");
