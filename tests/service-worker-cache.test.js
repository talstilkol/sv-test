...
describe("service worker cache freshness", () => {
  ...
  it("uses a fresh cache version for concept sprint assets", () => {
    expect(sw).toContain('const CACHE_VERSION = "lumen-v2.4.136-autosave"');
    expect(html).toContain("style.css?v=concept-sprint-v69");
    expect(html).toContain("app.js?v=top-bar-perf-v101");
    ...
    expect(sw).toContain("/app.js?v=top-bar-perf-v101");
