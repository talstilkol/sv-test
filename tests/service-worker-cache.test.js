...
describe("service worker cache freshness", () => {
  ...
  it("uses a fresh cache version for concept sprint assets", () => {
    expect(sw).toContain('const CACHE_VERSION = "lumen-v2.4.129"');
    expect(html).toContain("style.css?v=concept-sprint-v68");
    expect(html).toContain("app.js?v=concept-sprint-v68");
    expect(html).toContain("/src/main.js?v=core-bootstrap-v2");
    expect(html).toContain("content-loader.js?v=content-validation-v1");
    expect(sw).toContain("/style.css?v=concept-sprint-v68");
    expect(sw).toContain("/app.js?v=concept-sprint-v68");
