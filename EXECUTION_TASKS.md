...
| `QUESTION_COVERAGE_TARGETS` | `mcGapCount: 541`, `fillGapCount: 536`, `ready:false` |
...
- [!] FWD-9.4 — `npm run questions:coverage-targets:strict` — חסום עד השלמת `1,532` MC ידניות ו-`981` Fill ידניות לפי [MANUAL_QUESTION_AUTHORING_PLAN.md](MANUAL_QUESTION_AUTHORING_PLAN.md).
