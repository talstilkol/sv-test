...
- Sample ratio: 10%
- Sample size: 27
- Sample mix: 12 MC, 15 Fill
- Source mix: 27 manual
...
| 4 | pending | `mc_l25_grid_003` | mc | manual | `lesson_25::grid` | 6 | איזו טעות נפוצה ב-Grid תגרום לכרטיסים לא להסתדר בעמודות? | [ ] correct-answer-verified<br>[ ] explanation-matches-answer<br>[ ] prerequisites-and-terms-covered<br>[ ] difficulty-fits-lesson-order<br>[ ] hebrew-is-clear<br>[ ] four-options-exactly<br>[ ] distractors-are-common-mistakes<br>[ ] no-guessing-cues |
| 5 | pending | `fill_exam_props_001` | fill | manual | `lesson_22::props` | 5 | function Card(input) { return <h2>{input.____}</h2>; } | [ ] correct-answer-verified<br>[ ] explanation-matches-answer<br>[ ] prerequisites-and-terms-covered<br>[ ] difficulty-fits-lesson-order<br>[ ] hebrew-is-clear<br>[ ] single-clear-blank<br>[ ] answer-not-leaked<br>[ ] hint-narrows-without-revealing |
| 6 | pending | `fill_node_001` | fill | manual | `lesson_16::File System` | 5 | import { readFile } from 'node:fs/promises'; const text = await readFile('notes.txt', '____'); | [ ] correct-answer-verified<br>[ ] explanation-matches-answer<br>[ ] prerequisites-and-terms-covered<br>[ ] difficulty-fits-lesson-order<br>[ ] hebrew-is-clear<br>[ ] single-clear-blank<br>[ ] answer-not-leaked<br>[ ] hint-narrows-without-revealing |
| 7 | pending | `mc_tooling_deep_002` | mc | manual | `lesson_tooling_git::Git` | 6 | למה Git לא נחשב רק 'שמירה של קבצים'? | [ ] correct-answer-verified<br>[ ] explanation-matches-answer<br>[ ] prerequisites-and-terms-covered<br>[ ] difficulty-fits-lesson-order<br>[ ] hebrew-is-clear<br>[ ] four-options-exactly<br>[ ] distractors-are-common-mistakes<br>[ ] no-guessing-cues |
| 8 | pending | `mc_l25_flex_001` | mc | manual | `lesson_25::flex` | 3 | מה עושה display flex על parent? | [ ] correct-answer-verified<br>[ ] explanation-matches-answer<br>[ ] prerequisites-and-terms-covered<br>[ ] difficulty-fits-lesson-order<br>[ ] hebrew-is-clear<br>[ ] four-options-exactly<br>[ ] distractors-are-common-mistakes<br>[ ] no-guessing-cues |
| 9 | pending | `fill_html_css_004` | fill | manual | `lesson_html_css_foundations::CSS selector` | 3 | ____ { padding: 16px; border: 1px solid #ddd; } | [ ] correct-answer-verified<br>[ ] explanation-matches-answer<br>[ ] prerequisites-and-terms-covered<br>[ ] difficulty-fits-lesson-order<br>[ ] hebrew-is-clear<br>[ ] single-clear-blank<br>[ ] answer-not-leaked<br>[ ] hint-narrows-without-revealing |
| 10 | pending | `fill_design_003` | fill | manual | `lesson_design_systems::component registry` | 5 | const registry = { Button, Card, ____ }; const Component = registry[name]; | [ ] correct-answer-verified<br>[ ] explanation-matches-answer<br>[ ] prerequisites-and-terms-covered<br>[ ] difficulty-fits-lesson-order<br>[ ] hebrew-is-clear<br>[ ] single-clear-blank<br>[ ] answer-not-leaked<br>[ ] hint-narrows-without-revealing |
| 11 | pending | `mc_ai_dev_cursor_002` | mc | manual | `ai_development::Cursor` | 5 | מה התפקיד של קובץ .cursorrules בפרויקט? | [ ] correct-answer-verified<br>[ ] explanation-matches-answer<br>[ ] prerequisites-and-terms-covered<br>[ ] difficulty-fits-lesson-order<br>[ ] hebrew-is-clear<br>[ ] four-options-exactly<br>[ ] distractors-are-common-mistakes<br>[ ] no-guessing-cues |
| 12 | pending | `fill_obj_004` | fill | manual | `lesson_13::inheritance` | 5 | class Admin ____ User { canDeleteUsers() { return true; } } | [ ] correct-answer-verified<br>[ ] explanation-matches-answer<br>[ ] prerequisites-and-terms-covered<br>[ ] difficulty-fits-lesson-order<br>[ ] hebrew-is-clear<br>[ ] single-clear-blank<br>[ ] answer-not-leaked<br>[ ] hint-narrows-without-revealing |
| 13 | pending | `fill_arr_005` | fill | manual | `lesson_11::push` | 1 | const arr = [1, 2]; arr.____(3); console.log(arr); // [1, 2, 3] | [ ] correct-answer-verified<br>[ ] explanation-matches-answer<br>[ ] prerequisites-and-terms-covered<br>[ ] difficulty-fits-lesson-order<br>[ ] hebrew-is-clear<br>[ ] single-clear-blank<br>[ ] answer-not-leaked<br>[ ] hint-narrows-without-revealing |
| 14 | pending | `fill_mongo_001` | fill | manual | `lesson_20::findOne` | 4 | const user = await User.____({ email: 'a@b.com' }); | [ ] correct-answer-verified<br>[ ] explanation-matches-answer<br>[ ] prerequisites-and-terms-covered<br>[ ] difficulty-fits-lesson-order<br>[ ] hebrew-is-clear<br>[ ] single-clear-blank<br>[ ] answer-not-leaked<br>[ ] hint-narrows-without-revealing |
| 15 | pending | `mc_tooling_008` | mc | manual | `lesson_tooling_git::npm scripts` | 3 | איפה מגדירים פקודות כמו npm run dev ו-npm test? | [ ] correct-answer-verified<br>[ ] explanation-matches-answer<br>[ ] prerequisites-and-terms-covered<br>[ ] difficulty-fits-lesson-order<br>[ ] hebrew-is-clear<br>[ ] four-options-exactly<br>[ ] distractors-are-common-mistakes<br>[ ] no-guessing-cues |
| 16 | pending | `fill_tooling_009` | fill | manual | `lesson_tooling_git::repository` | 5 | git ____ https://github.com/team/app.git cd app | [ ] correct-answer-verified<br>[ ] explanation-matches-answer<br>[ ] prerequisites-and-terms-covered<br>[ ] difficulty-fits-lesson-order<br>[ ] hebrew-is-clear<br>[ ] single-clear-blank<br>[ ] answer-not-leaked<br>[ ] hint-narrows-without-revealing |
| 17 | pending | `fill_st_001` | fill | manual | `lesson_13::localStorage` | 3 | const tasks = [{id:1}]; localStorage.setItem('tasks', JSON.____(tasks)); | [ ] correct-answer-verified<br>[ ] explanation-matches-answer<br>[ ] prerequisites-and-terms-covered<br>[ ] difficulty-fits-lesson-order<br>[ ] hebrew-is-clear<br>[ ] single-clear-blank<br>[ ] answer-not-leaked<br>[ ] hint-narrows-without-revealing |
| 18 | pending | `fill_next_002` | fill | manual | `lesson_nextjs::image optimization` | 5 | <Image src="/hero.png" alt="Dashboard" width={1200} height={____} /> | [ ] correct-answer-verified<br>[ ] explanation-matches-answer<br>[ ] prerequisites-and-terms-covered<br>[ ] difficulty-fits-lesson-order<br>[ ] hebrew-is-clear<br>[ ] single-clear-blank<br>[ ] answer-not-leaked<br>[ ] hint-narrows-without-revealing |
| 19 | pending | `mc_ai_dev_review_001` | mc | manual | `ai_development::AI Code Review` | 3 | מה AI Code Review צריך לבדוק מעבר ל-'הקוד נראה יפה'? | [ ] correct-answer-verified<br>[ ] explanation-matches-answer<br>[ ] prerequisites-and-terms-covered<br>[ ] difficulty-fits-lesson-order<br>[ ] hebrew-is-clear<br>[ ] four-options-exactly<br>[ ] distractors-are-common-mistakes<br>[ ] no-guessing-cues |
| 20 | pending | `fill_async_004` | fill | manual | `lesson_15::Promise` | 5 | const p = new Promise((____, reject) => { setTimeout(() => /* fulfill with 'hello' */, 1000); }); | [ ] correct-answer-verified<br>[ ] explanation-matches-answer<br>[ ] prerequisites-and-terms-covered<br>[ ] difficulty-fits-lesson-order<br>[ ] hebrew-is-clear<br>[ ] single-clear-blank<br>[ ] answer-not-leaked<br>[ ] hint-narrows-without-revealing |
| 21 | pending | `fill_l25_tailwind_002` | fill | manual | `lesson_25::Tailwind CSS` | 5 | <button className="px-4 py-2 bg-blue-500 hover:bg-blue-700 ____">Save</button> | [ ] correct-answer-verified<br>[ ] explanation-matches-answer<br>[ ] prerequisites-and-terms-covered<br>[ ] difficulty-fits-lesson-order<br>[ ] hebrew-is-clear<br>[ ] single-clear-blank<br>[ ] answer-not-leaked<br>[ ] hint-narrows-without-revealing |
| 22 | pending | `mc_ai_dev_cursor_001` | mc | manual | `ai_development::Cursor` | 3 | מתי נכון להשתמש ב-Cursor Cmd+K? | [ ] correct-answer-verified<br>[ ] explanation-matches-answer<br>[ ] prerequisites-and-terms-covered<br>[ ] difficulty-fits-lesson-order<br>[ ] hebrew-is-clear<br>[ ] four-options-exactly<br>[ ] distractors-are-common-mistakes<br>[ ] no-guessing-cues |
| 23 | pending | `mc_middleware_001` | mc | manual | `lesson_17::middleware` | 5 | מה תפקיד הפרמטר next ב-middleware? | [ ] correct-answer-verified<br>[ ] explanation-matches-answer<br>[ ] prerequisites-and-terms-covered<br>[ ] difficulty-fits-lesson-order<br>[ ] hebrew-is-clear<br>[ ] four-options-exactly<br>[ ] distractors-are-common-mistakes<br>[ ] no-guessing-cues |
| 24 | pending | `mc_html_css_005` | mc | manual | `lesson_html_css_foundations::CSS selector` | 3 | איזה selector בוחר אלמנט עם class בשם card? | [ ] correct-answer-verified<br>[ ] explanation-matches-answer<br>[ ] prerequisites-and-terms-covered<br>[ ] difficulty-fits-lesson-order<br>[ ] hebrew-is-clear<br>[ ] four-options-exactly<br>[ ] distractors-are-common-mistakes<br>[ ] no-guessing-cues |
| 25 | pending | `mc_tooling_deep_004` | mc | manual | `lesson_tooling_git::staging area` | 6 | שינית שני קבצים, אבל רק אחד קשור לבאג שאתה מתקן. מה הפעולה הנכונה לפני commit? | [ ] correct-answer-verified<br>[ ] explanation-matches-answer<br>[ ] prerequisites-and-terms-covered<br>[ ] difficulty-fits-lesson-order<br>[ ] hebrew-is-clear<br>[ ] four-options-exactly<br>[ ] distractors-are-common-mistakes<br>[ ] no-guessing-cues |
| 26 | pending | `mc_l25_flex_002` | mc | manual | `lesson_25::flex` | 4 | איזה className מתאים ל-navbar עם לוגו בקצה אחד וקישורים בקצה השני? | [ ] correct-answer-verified<br>[ ] explanation-matches-answer<br>[ ] prerequisites-and-terms-covered<br>[ ] difficulty-fits-lesson-order<br>[ ] hebrew-is-clear<br>[ ] four-options-exactly<br>[ ] distractors-are-common-mistakes<br>[ ] no-guessing-cues |
| 27 | pending | `fill_ai_dev_review_001` | fill | manual | `ai_development::AI Code Review` | 5 | const review = ['logic', 'security', 'performance', '____']; | [ ] correct-answer-verified<br>[ ] explanation-matches-answer<br>[ ] prerequisites-and-terms-covered<br>[ ] difficulty-fits-lesson-order<br>[ ] hebrew-is-clear<br>[ ] single-clear-blank<br>[ ] answer-not-leaked<br>[ ] hint-narrows-without-revealing |
