...
| Check | Status | Detail |
|---|---|---|
| Exam-critical learning remains unlocked | pass | Pricing must not block lessons, concepts, mock exams, explanations or local progress evidence. |
| Post-exam packages are defined | pass | Packaging must define core learning and post-exam service layers. |
