...
var COURSE_BLUEPRINTS = [
  {
    ...
    modules: [
      ...
      },
      {
        ...
        status: "covered",
        lessonIds: ["lesson_25", "react_blueprint", "lesson_design_systems"],
        conceptKeys: [
          ...
          "lesson_design_systems::form field composition",
          "lesson_design_systems::theme tokens",
          "lesson_design_systems::component registry",
          "lesson_design_systems::design system testing",
        ],
        examFocus: "Tailwind + shadcn/UI bridge: utility classes, component architecture, Radix/accessibility primitives, design tokens, variants/cva, cn helper, asChild slot, form composition, theme tokens, registry ו-design-system testing.",
      },
      {
      ...
      },
      {
        ...
        status: "covered",
        lessonIds: ["lesson_ai_engineering"],
        conceptKeys: [
          "lesson_ai_engineering::OpenAI API",
          "lesson_ai_engineering::Vercel AI SDK",
          ...
          "lesson_ai_engineering::tool calling",
          "lesson_ai_engineering::agent loop",
          "lesson_ai_engineering::guardrails",
          "lesson_ai_engineering::hallucination check",
          "lesson_ai_engineering::evaluation",
          "lesson_ai_engineering::fine-tuning boundary",
        ],
        examFocus: "AI Engineering bridge: OpenAI API, Vercel AI SDK, LangChain, model selection, prompt messages, structured output, streaming, token budget, embeddings, vector store, RAG, chunking, retrieval ranking, tool calling, agent loops, guardrails, hallucination checks, evaluation וגבולות fine-tuning.",
      },
    ],
    capstoneLinks: ["capstone_task_manager", "capstone_movie_app", "capstone_auth_crud", "capstone_dashboard", "capstone_svcollege_ai_saas"],
    mockExamTags: ["svcollege_fullstack", "js_foundations", "react_full", "all_full"],
    recommendedNext: [
      "עדיפות 1: לשמור את readiness release ללא blockers ולהרחיב QA ידני לכל הטאבים לפני המבחן.",
