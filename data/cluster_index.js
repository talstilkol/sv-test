...
(function () {
  ...
  const CLUSTERS = [
    ...
    // ─── PHASE J: orphan absorption (2026-05-02 evening) ───
    { id: "oop_class_basics", title: "OOP & Classes — class/extends/super/instance/new/method", members: ["class", "extends", "super", "constructor", "instance", "method", "Method", "new", "Property", "inheritance"], lessons: ["lesson_13", "lesson_19"], difficulty: 6, docSection: null },
    { id: "dom_basics", title: "DOM Basics — Document Object Model / style / attribute", members: ["DOM", "Document Object Model", "style", "attribute", "Value"], lessons: ["lesson_13", "lesson_19"], difficulty: 5, docSection: null },
    { id: "browser_storage_full", title: "Browser Storage — localStorage / sessionStorage / cookies / setItem / getItem", members: ["setItem", "getItem", "removeItem", "cookies"], lessons: ["lesson_13", "lesson_19"], difficulty: 5, docSection: null },
    { id: "array_basics", title: "Array Basics — Index / new array / iteration patterns", members: ["Index", "index", "יצירת מערך חדש (new array)", "יצירת מערך חדש מתוך קיים", "סינון לפי תנאי", "עבודה עם ערכים לפי אינדקס", "array of objects", "nested object"], lessons: ["lesson_11", "lesson_12", "lesson_19"], difficulty: 4, docSection: null },
    { id: "string_basics", title: "String Basics — toString and conversion", members: ["toString"], lessons: ["lesson_11"], difficulty: 4, docSection: null },
    { id: "node_fs", title: "Node.js fs API — readFile/writeFile/appendFile/unlink/rename", members: ["fs", "fs.readFile", "fs.writeFile", "fs.appendFile", "fs.open", "fs.rename", "fs.unlink", "File System"], lessons: ["lesson_16"], difficulty: 5, docSection: null },
    { id: "cli_basics", title: "CLI Basics — dir/mkdir/CLI/Command Line", members: ["CLI", "Command Line Interface", "dir", "mkdir", "type nul", "node file.js", "npm start"], lessons: ["lesson_16"], difficulty: 5, docSection: null },
    { id: "js_runtime", title: "JS Runtimes — Node.js / V8 / module / Express / Server", members: ["Node.js", "V8", "module", "Express", "server", "Server", "Client", "Domain"], lessons: ["lesson_16", "lesson_17", "lesson_18"], difficulty: 5, docSection: null },
    { id: "http_protocol_basics", title: "HTTP Protocol Basics — HTTP / Protocol / REST / port / Request/Response", members: ["HTTP", "Protocol", "REST API", "port", "method", "Status Codes", "Request", "Response", "Read", "Update", "headers", "Query Parameters", "static files", "Domain", "1xx-2xx-3xx", "4xx-5xx", "app", "app.listen"], lessons: ["lesson_17", "lesson_18"], difficulty: 6, docSection: null },
    { id: "form_basics", title: "Form Basics — email/password/username/form/validation", members: ["form", "email", "password", "username", "validation", "server-side storage"], lessons: ["lesson_17", "lesson_18"], difficulty: 5, docSection: null },
    { id: "browser_dev_tools", title: "Browser Dev Tools — alert / console.log / debugger / network", members: ["alert", "console.log", "debugger", "network", "script"], lessons: ["lesson_19"], difficulty: 4, docSection: null },
    { id: "control_flow", title: "Control Flow — break/continue/return", members: ["break", "continue", "return"], lessons: ["lesson_19"], difficulty: 4, docSection: null },
    { id: "js_fundamentals", title: "JS Fundamentals — camelCase/hoisting/parameter/Data Types", members: ["camelCase", "hoisting", "parameter", "Data Types"], lessons: ["lesson_19"], difficulty: 4, docSection: null },
    { id: "mongo_query_operators", title: "MongoDB Query Operators — $eq/$gt/$gte/$lt/$lte/$ne", members: ["$eq", "$gt", "$gte", "$lt", "$lte", "$ne"], lessons: ["lesson_20"], difficulty: 5, docSection: null },
    { id: "mongo_basics", title: "MongoDB Basics — Cluster/Collection/Connection String/Atlas", members: ["Cluster", "Collection", "Connection String", "MongoDB Atlas"], lessons: ["lesson_20"], difficulty: 5, docSection: null },
    { id: "mongo_modify", title: "MongoDB Modify — update / deleteOne / deleteMany / updateMany", members: ["update", "updateMany", "deleteOne", "deleteMany"], lessons: ["lesson_20"], difficulty: 5, docSection: null },
    { id: "react_files", title: "React Project Files — App.jsx / index.html / main.jsx / App.css", members: ["App.jsx", "App.css", "index.html", "main.jsx", "{}", "CSS import"], lessons: ["lesson_21"], difficulty: 4, docSection: null },
    { id: "react_styling", title: "React Styling — className / inline style", members: ["className", "inline style"], lessons: ["lesson_21"], difficulty: 4, docSection: null },
    { id: "react_ecosystem", title: "React Ecosystem — React / React Native / Vite", members: ["React", "React Native", "Vite", "RFC", "Component", "Client Side"], lessons: ["lesson_21"], difficulty: 4, docSection: null },
    { id: "react_components_handlers", title: "React Components & Handlers — addPost / deletePost / MainScreen / PostList / AddPost / element", members: ["addPost", "deletePost", "MainScreen", "PostList", "AddPost", "element"], lessons: ["lesson_22", "lesson_23"], difficulty: 5, docSection: null },
    { id: "react_context_pattern", title: "React Context Pattern — createContext / Provider / Prop Drilling", members: ["createContext", "Provider", "Prop Drilling"], lessons: ["lesson_23"], difficulty: 6, docSection: null },
    { id: "useref_patterns", title: "useRef Patterns — ref / ref.current / focus / state update", members: ["ref", "ref.current", "focus", "state update", "expensive calculation", "side effect"], lessons: ["lesson_24"], difficulty: 6, docSection: null },
    { id: "tailwind_basics", title: "Tailwind Basics — utility classes / installation / responsive / rounded / bg", members: ["utility classes", "Tailwind installation", "Tailwind CSS", "responsive design", "rounded", "bg color", "rating", "search", "navbar", "add/delete movie"], lessons: ["lesson_25"], difficulty: 5, docSection: null },
    { id: "ts_setup", title: "TypeScript Setup — tsconfig.json / Compiler / .js → .ts / models folder", members: ["Compiler", "tsconfig.json", ".js", "Todo.ts", "models folder", "Strongly Typed", "optional field"], lessons: ["lesson_26"], difficulty: 4, docSection: null },
    { id: "auth_providers", title: "Auth Providers — Supabase Auth / Firebase Auth / Kinde / Appwrite", members: ["Supabase Auth", "Firebase Auth", "Kinde/Appwrite", "provider auth", "middleware guard", "password hashing", "XSS boundary"], lessons: ["lesson_auth_security"], difficulty: 5, docSection: null },
    { id: "design_system_concepts", title: "Design System — shadcn/UI / cn helper / variants / tokens / Radix / cva", members: ["cn helper", "shadcn/UI", "component variants", "design tokens", "theme tokens", "Radix primitives", "cva", "asChild slot", "component registry", "accessible primitive", "form field composition", "design system testing"], lessons: ["lesson_design_systems"], difficulty: 6, docSection: null },
    { id: "devops_concepts", title: "DevOps Concepts — build / health check / smoke test / preview / release", members: ["build command", "smoke test", "release checklist", "preview deployment", "Docker", "Docker Compose", "environment variables", "health check", "production readiness", "service"], lessons: ["lesson_devops_deploy"], difficulty: 5, docSection: null },
    { id: "html_css_basics", title: "HTML/CSS Basics — HTML document / form / selector / semantic / label / cascade", members: ["HTML document", "HTML form", "CSS selector", "semantic HTML", "label", "accessibility basics", "cascade and specificity"], lessons: ["lesson_html_css_foundations"], difficulty: 4, docSection: null },
    { id: "nestjs_concepts", title: "Nest.js Concepts — module/controller/service/DTO/pipe/guard/interceptor", members: ["Nest.js", "module", "controller", "service", "DTO", "pipe", "guard", "interceptor", "decorator", "provider", "dependency injection", "exception filter", "repository pattern", "validation pipe", "testing module"], lessons: ["lesson_nestjs"], difficulty: 5, docSection: null },
    { id: "nextjs_concepts", title: "Next.js Concepts — App Router / SSR/SSG / API route / dynamic route / metadata", members: ["Next.js", "App Router", "API route", "dynamic route", "page", "layout", "metadata API", "SEO", "image optimization", "client component", "server component", "route handler", "server action", "file-system routing"], lessons: ["lesson_nextjs"], difficulty: 5, docSection: null },
    { id: "sql_concepts", title: "SQL Concepts — table/row/column/JOIN/foreign key/migration/CRUD/transaction", members: ["table", "row", "column", "primary key", "foreign key", "JOIN", "relation", "migration", "ORM", "Prisma", "Drizzle", "transaction", "CRUD"], lessons: ["lesson_sql_orm"], difficulty: 4, docSection: null },
