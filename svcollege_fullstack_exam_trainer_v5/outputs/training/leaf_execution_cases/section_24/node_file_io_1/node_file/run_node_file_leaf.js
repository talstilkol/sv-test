...
try {
  ...
  if (typeof instance.rename === 'function') await maybeAwait(instance.rename(renamedPath));
  checks.push({ name: 'rename file', ok: fs.existsSync(renamedPath) });
  if (typeof instance.copy === 'function') await maybeAwait(instance.copy(copiedPath));
