...
function buildReport() {
  ...
  addCheck(
    ...
    html.includes("app.js?v=concept-sprint-v68") &&
      html.includes("style.css?v=concept-sprint-v68") &&
      read("service-worker.js").includes('const CACHE_VERSION = "lumen-v2.4.129"') &&
