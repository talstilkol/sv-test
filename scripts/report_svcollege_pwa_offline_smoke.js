...
function buildReport() {
  ...
  const strategyChecks = [
    ...
    ["service worker registration", html.includes("app.js?v=concept-colors-v92") && sw.includes('self.addEventListener("install"') && read("app.js").includes('.register("service-worker.js", { scope: "/" })')],
