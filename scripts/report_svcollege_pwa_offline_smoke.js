...
function buildReport() {
  ...
  const strategyChecks = [
    ...
    ["service worker registration", html.includes("app.js?v=homework-exam-mode-v6") && sw.includes('self.addEventListener("install"') && read("app.js").includes('.register("service-worker.js", { scope: "/" })')],
    ["cache version", /const\s+CACHE_VERSION\s*=\s*"lumen-v2\.[^"]+"/.test(sw)],
