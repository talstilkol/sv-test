...
function buildReport() {
  ...
  const strategyChecks = [
    ...
    ["service worker registration", html.includes("app.js?v=simple-tree-v86") && sw.includes('self.addEventListener("install"') && read("app.js").includes('.register("service-worker.js", { scope: "/" })')],
