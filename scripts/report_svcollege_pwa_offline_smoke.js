...
function buildReport() {
  ...
  const strategyChecks = [
    ...
    ["service worker registration", html.includes("app.js?v=nav-buttons-v89") && sw.includes('self.addEventListener("install"') && read("app.js").includes('.register("service-worker.js", { scope: "/" })')],
