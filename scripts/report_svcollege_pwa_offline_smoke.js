...
function buildReport() {
  ...
  const strategyChecks = [
    ...
    ["service worker registration", html.includes("app.js?v=top-bar-perf-v97") && sw.includes('self.addEventListener("install"') && read("app.js").includes('.register("service-worker.js", { scope: "/" })')],
    ["cache version", sw.includes('const CACHE_VERSION = "lumen-v2.4.132-autosave"')],
