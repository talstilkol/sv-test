...
const CLUSTER_CONTENT_STATUS = {
  ...
  array_methods:              { table: true, overview: true, perMember: true, codeBlocks: true },
  ...
  browser_storage: { table: true, overview: true, perMember: true, codeBlocks: true },
  http_methods: { table: true, overview: true, perMember: true, codeBlocks: true },
  databases:                  { table: true, overview: true, perMember: true, codeBlocks: true },
  module_system: { table: true, overview: true, perMember: true, codeBlocks: true },
  auth_security: { table: true, overview: true, perMember: true, codeBlocks: true },
  typescript_basics: { table: true, overview: true, perMember: true, codeBlocks: true },
  primitive_types:            { table: true, overview: true, perMember: true, codeBlocks: true },
  array_mutation_methods: { table: true, overview: true, perMember: true, codeBlocks: true },
  dom_selectors: { table: true, overview: true, perMember: true, codeBlocks: true },
  dom_traversal_children: { table: true, overview: true, perMember: true, codeBlocks: true },
  npm_commands: { table: true, overview: true, perMember: true, codeBlocks: true },
  error_handling: { table: true, overview: true, perMember: true, codeBlocks: true },
  dom_events: { table: true, overview: true, perMember: true, codeBlocks: true },
  react_router_nav: { table: true, overview: true, perMember: true, codeBlocks: true },
  json_methods: { table: true, overview: true, perMember: true, codeBlocks: true },
  to_number: { table: true, overview: true, perMember: true, codeBlocks: true },
  type_check:                 { table: true, overview: true, perMember: true, codeBlocks: true },
  string_methods: { table: true, overview: true, perMember: true, codeBlocks: true },
  math_object: { table: true, overview: true, perMember: true, codeBlocks: true },
  ...
  string_building: { table: true, overview: true, perMember: true, codeBlocks: true },
  associative_structures:     { table: true, overview: true, perMember: true, codeBlocks: true },
  object_static_methods: { table: true, overview: true, perMember: true, codeBlocks: true },
  deep_copy: { table: true, overview: true, perMember: true, codeBlocks: true },
  date_apis: { table: true, overview: true, perMember: true, codeBlocks: true },
  ...
  timers: { table: true, overview: true, perMember: true, codeBlocks: true },
  event_loop:                 { table: true, overview: true, perMember: true, codeBlocks: true },
  http_clients:               { table: true, overview: true, perMember: true, codeBlocks: true },
  dom_text_writing:           { table: true, overview: true, perMember: true, codeBlocks: true },
  dom_node_inserting: { table: true, overview: true, perMember: true, codeBlocks: true },
  dom_node_creation: { table: true, overview: true, perMember: true, codeBlocks: true },
  classlist_api: { table: true, overview: true, perMember: true, codeBlocks: true },
  dom_attributes: { table: true, overview: true, perMember: true, codeBlocks: true },
  ...
  express_routing_handlers: { table: true, overview: true, perMember: true, codeBlocks: true },
  express_response: { table: true, overview: true, perMember: true, codeBlocks: true },
  mongo_find: { table: true, overview: true, perMember: true, codeBlocks: true },
  mongo_create: { table: true, overview: true, perMember: true, codeBlocks: true },
  mongo_operators: { table: true, overview: true, perMember: true, codeBlocks: true },
  mongoose_concepts:          { table: true, overview: true, perMember: true, codeBlocks: true },
  component_kinds: { table: true, overview: true, perMember: true, codeBlocks: true },
  ...
  react_grouping: { table: true, overview: true, perMember: true, codeBlocks: true },
  form_control: { table: true, overview: true, perMember: true, codeBlocks: true },
  composition_patterns: { table: true, overview: true, perMember: true, codeBlocks: true },
  error_catching: { table: true, overview: true, perMember: true, codeBlocks: true },
  ...
  ts_utility_types: { table: true, overview: true, perMember: true, codeBlocks: true },
  ts_const_enum: { table: true, overview: true, perMember: true, codeBlocks: true },
  ts_class_modifiers: { table: true, overview: true, perMember: true, codeBlocks: true },
  auth_methods: { table: true, overview: true, perMember: true, codeBlocks: true },
  cookie_flags: { table: true, overview: true, perMember: true, codeBlocks: true },
  token_lifecycle: { table: true, overview: true, perMember: true, codeBlocks: true },
  ...
  git_core: { table: true, overview: true, perMember: true, codeBlocks: true },
  git_merge_strategy: { table: true, overview: true, perMember: true, codeBlocks: true },
  deps_kinds: { table: true, overview: true, perMember: true, codeBlocks: true },
  package_managers: { table: true, overview: true, perMember: true, codeBlocks: true },
  code_quality_tools: { table: true, overview: true, perMember: true, codeBlocks: true },
  rendering_strategies:       { table: true, overview: true, perMember: true, codeBlocks: true },
  deploy_platforms: { table: true, overview: true, perMember: true, codeBlocks: true },
  docker_concepts: { table: true, overview: true, perMember: true, codeBlocks: true },
  cicd: { table: true, overview: true, perMember: true, codeBlocks: true },
  function_definition_kinds:  { table: true, overview: true, perMember: true, codeBlocks: true },
  mutability_patterns: { table: true, overview: true, perMember: true, codeBlocks: true },
  code_decisions: { table: true, overview: true, perMember: true, codeBlocks: true },
  array_reference_cluster:    { table: true, overview: true, perMember: true, codeBlocks: true },
  jsx_rendering: { table: true, overview: true, perMember: true, codeBlocks: true },
  ...
  oop_class_basics: { table: true, overview: true, perMember: true, codeBlocks: true },
  dom_basics: { table: true, overview: true, perMember: true, codeBlocks: true },
  browser_storage_full: { table: true, overview: true, perMember: true, codeBlocks: true },
  array_basics: { table: true, overview: true, perMember: true, codeBlocks: true },
  string_basics: { table: true, overview: true, perMember: true, codeBlocks: true },
  node_fs: { table: true, overview: true, perMember: true, codeBlocks: true },
  cli_basics: { table: true, overview: true, perMember: true, codeBlocks: true },
  js_runtime: { table: true, overview: true, perMember: true, codeBlocks: true },
  http_protocol_basics: { table: true, overview: true, perMember: true, codeBlocks: true },
  form_basics: { table: true, overview: true, perMember: true, codeBlocks: true },
  browser_dev_tools: { table: true, overview: true, perMember: true, codeBlocks: true },
  control_flow: { table: true, overview: true, perMember: true, codeBlocks: true },
  js_fundamentals: { table: true, overview: true, perMember: true, codeBlocks: true },
  mongo_query_operators: { table: true, overview: true, perMember: true, codeBlocks: true },
  mongo_basics: { table: true, overview: true, perMember: true, codeBlocks: true },
  mongo_modify: { table: true, overview: true, perMember: true, codeBlocks: true },
  react_files: { table: true, overview: true, perMember: true, codeBlocks: true },
  react_styling: { table: true, overview: true, perMember: true, codeBlocks: true },
  react_ecosystem: { table: true, overview: true, perMember: true, codeBlocks: true },
  react_components_handlers: { table: true, overview: true, perMember: true, codeBlocks: true },
  react_context_pattern: { table: true, overview: true, perMember: true, codeBlocks: true },
  useref_patterns: { table: true, overview: true, perMember: true, codeBlocks: true },
  tailwind_basics: { table: true, overview: true, perMember: true, codeBlocks: true },
  ts_setup: { table: true, overview: true, perMember: true, codeBlocks: true },
  auth_providers: { table: true, overview: true, perMember: true, codeBlocks: true },
  design_system_concepts: { table: true, overview: true, perMember: true, codeBlocks: true },
  devops_concepts: { table: true, overview: true, perMember: true, codeBlocks: true },
  html_css_basics: { table: true, overview: true, perMember: true, codeBlocks: true },
  nestjs_concepts: { table: true, overview: true, perMember: true, codeBlocks: true },
  nextjs_concepts: { table: true, overview: true, perMember: true, codeBlocks: true },
  sql_concepts: { table: true, overview: true, perMember: true, codeBlocks: true },
  git_workflow: { table: true, overview: true, perMember: true, codeBlocks: true },
  express_form_events: { table: true, overview: true, perMember: true, codeBlocks: true },
  scope_chain_cluster: { table: true, overview: true, perMember: true, codeBlocks: true },
  // ─── final orphan absorbers (round 2) ───
  dom_remove_node: { table: true, overview: true, perMember: true, codeBlocks: true },
  error_objects: { table: true, overview: true, perMember: true, codeBlocks: true },
  if_else_cluster: { table: true, overview: true, perMember: true, codeBlocks: true },
  vite_creation: { table: true, overview: true, perMember: true, codeBlocks: true },
  react_hook_basics: { table: true, overview: true, perMember: true, codeBlocks: true },
  ts_advanced_types: { table: true, overview: true, perMember: true, codeBlocks: true },
  ts_app_models: { table: true, overview: true, perMember: true, codeBlocks: true },
  ai_engineering_full: { table: true, overview: true, perMember: true, codeBlocks: true },
  auth_attacks: { table: true, overview: true, perMember: true, codeBlocks: true },
  workbook_basics: { table: true, overview: true, perMember: true, codeBlocks: true },
  ai_dev_tools: { table: true, overview: true, perMember: true, codeBlocks: true },
};
